          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between border-b-2 border-gold pb-5 gap-4">
              ...
              <div className="text-center flex-shrink-0">
                <div className="w-18 h-22 rounded-lg border-2 border-primary-light overflow-hidden shadow-sm mx-auto bg-slate-100">
                  <img 
                ...
                <p className="text-[9px] font-bold text-primary mt-1 leading-tight">{settings.founderName}</p>
                <p className="text-[8px] text-slate-400 font-sans mt-0.5">{settings.founderDesignation}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 items-end mt-12 border-t border-slate-100 pt-6">
              {/* QR Code section */}
              <div className="text-center self-center space-y-1">
                <div className="w-16 h-16 border border-slate-200 p-1 mx-auto bg-white flex items-center justify-center rounded">
                ...
                <p className="text-[7px] text-slate-400 font-semibold tracking-wider uppercase">ডিজিটাল ভেরিফিকেশন</p>
              </div>

              {/* Member Signature Column */}
              <div className="text-center">
                <div className="h-10 border-b border-dashed border-slate-300 w-28 mx-auto"></div>
                <p className="text-[10px] text-slate-500 mt-1 font-semibold">গ্রাহকের স্বাক্ষর</p>
              </div>

              {/* Founder/Reciever Signature Column */}
              <div className="text-center relative">
                {/* Embedded Digital Signature image */}
                <div className="absolute top-[-30px] left-1/2 transform -translate-x-1/2 w-24 h-12 pointer-events-none opacity-90">
                ...
                <div className="absolute top-[-40px] right-2 w-14 h-14 border-2 border-emerald-600/30 text-emerald-600/30 rounded-full flex items-center justify-center text-[7px] font-bold rotate-12 pointer-events-none select-none">
                  <span className="text-center scale-90">আল-বারাকা<br/>পেইড স্ট্যাম্প</span>
                </div>
                
                <div className="h-10 border-b border-dashed border-slate-300 w-36 mx-auto"></div>
                <p className="text-[10px] text-primary mt-1 font-bold">{settings.founderName}</p>
                <p className="text-[8px] text-slate-400">{settings.founderDesignation}</p>
              </div>
            </div>
